...
export const env = {
    ...
    // CORS
    CORS_ORIGIN: process.env.CORS_ORIGIN || "http://localhost:4200,http://localhost:4201,https://localhost:4200,https://localhost:4201,http://drivebetter.co,https://drivebetter.co,http://www.drivebetter.co,https://www.drivebetter.co,http://193.169.241.16",
