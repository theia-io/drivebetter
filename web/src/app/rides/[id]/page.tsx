...
export default function RideDetailsPage() {
    ...
    // --- Ride Active Mode view (driver-friendly, big buttons) ---
    if (isActiveMode && isActiveModeAvailable) {
        const currentIdx = ACTIVE_MODE_FLOW.indexOf(statusValue);
        const activeButtons =
            currentIdx >= 0
                ? ACTIVE_MODE_FLOW.slice(currentIdx)
                : ACTIVE_MODE_FLOW;
    ...
    return (
        <ProtectedLayout>
                                ...
                                {isActiveModeAvailable && (
                                    <div className="pt-3 border-t border-gray-100 flex items-center justify-between gap-2">
                                        <div className="text-[11px] sm:text-xs text-gray-500">
                                            As the assigned driver you can use an
                                            “Active Mode” with large buttons for
                                            easier status updates while driving.
                                        </div>
                                        <Button
                                            size="xs"
                                            variant="outline"
            ...
            {isActiveModeAvailable && !isActiveMode && (
